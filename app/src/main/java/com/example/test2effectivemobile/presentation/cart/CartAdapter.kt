...
class CartAdapter :
    ListAdapter<Basket, CartAdapter.ItemHolder>(object : DiffUtil.ItemCallback<Basket>() {
    ...
    class ItemHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun setData(item: Basket) {
            ...
            Glide.with(binding.root.context).load(item.images).centerCrop()
                .into(binding.imPhoneImage)
        }
    }
